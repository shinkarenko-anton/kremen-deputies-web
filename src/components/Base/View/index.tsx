...
import React, { LegacyRef, MouseEvent, PureComponent, ReactNode, Ref, RefObject } from 'react';
...
export class View extends PureComponent<IProps> {
  render() {
    const {
      className, style, children, row, column, flex, direction, justifyContent, alignItems, cursor, onClick, divRef,
