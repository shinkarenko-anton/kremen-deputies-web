import { Image, Link, View } from 'components/Base';
...
const AppInfo: FC<IProps> = ({ style }) => {
  return (
    ...
    >
      ...
      <p>
        Додаток не є комерційним і створений завласної ініціативи кременчуцьких програмістів
        місцевої IT-спільноти <Link href="http://io.kr.ua/">IQ Hub</Link>.
      </p>
      <p>
      ...
      <p style={styles.contactRow}>
        ...
        <Link href="https://fb.me/snipter/">
          fb.me/snipter
        </Link>
      </p>
      <p style={styles.contactRow}>
        <Image style={styles.icon} src={LogoSlack}/>
        <Link href="https://slack.io.kr.ua/">
          slack.io.kr.ua
        </Link>
      </p>
      <p style={styles.contactRow}>
