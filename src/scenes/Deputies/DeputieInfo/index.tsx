...
export class DeputieInfo extends PureComponent<IProps> {
  render() {
    ...
    return (
      ...
      >
        ...
        <View style={styles.infoWrap}>
          {!!name && (
            <View style={[ styles.row, styles.name ]}>{name}</View>
          )}
          {!!schedule && (
          ...
          {!!twitter && (
            <View style={styles.row} row={true}>
              ...
              <View><a href={twitter} target="__blank">{twitter}</a></View>
            </View>
          )}
          {(phones && phones.length) && (
            phones.map((phone, key) => (
              <View key={key} style={styles.row} row={true}>
                ...
                <View>
                  <a href={`tel:${phone}`} target="__blank">{phone}</a>
                </View>
              </View>
            ))
          )}
